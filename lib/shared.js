...
.home-section-card-icon {
  ...
  font-size: 24px; background: linear-gradient(135deg, rgba(36,90,36,0.08), rgba(36,90,36,0.03));
  flex-shrink: 0;
}
...
.home-section-card-count {
  font-size: 12px; color: var(--text-light); font-weight: 500; margin-top: 2px;
}
...
.home-section-card-list li {
  padding: 7px 0; border-top: 1px solid var(--cream-border);
  font-size: 13px; color: var(--text); display: flex; align-items: center; gap: 8px;
}
.home-section-card-list li:first-child { border-top: none; }
.home-section-card-list li::before {
  content: ''; width: 5px; height: 5px; border-radius: 50%;
  background: var(--green); opacity: 0.4; flex-shrink: 0;
}
.home-section-card-arrow {
  font-size: 20px; color: var(--text-light); transition: all 0.25s;
  margin-top: 18px; padding-top: 14px; border-top: 1px solid var(--cream-border);
  display: flex; align-items: center; justify-content: space-between;
}
.home-section-card-arrow span {
  font-size: 12px; font-weight: 600; color: var(--green);
}
.home-section-card:hover .home-section-card-arrow {
  color: var(--green);
}
.home-section-card:hover .home-section-card-arrow::after {
...
.home-featured-item {
  ...
  transition: all 0.2s; font-size: 13px; font-weight: 500; cursor: pointer;
}
